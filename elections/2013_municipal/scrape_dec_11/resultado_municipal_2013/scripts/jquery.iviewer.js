...
$.widget( "ui.iviewer", $.ui.mouse, {
	...
	this.heigthPrinted = this.options.heigthPrinted;
	globalHeight=this.heigthPrinted;	

	this.widthPrinted = this.options.widthPrinted;	
	globalWidth=this.widthPrinted;	
...
*/
        ...
        $("<div>", { 'class': "iviewer_print iviewer_common iviewer_button"})
                    .bind('mousedown touchstart',function(){
				var printWindow = window.open('', 'Print Window');
				printWindow.document.write('<html><head><title>Print Window</title>');
				printWindow.document.write('</head><body ><img src=\'');
				printWindow.document.write($('#imageToBeViewed').attr('src'));
				
				if(globalWidth != null){
					printWindow.document.write('\' width='+globalWidth+'%');
				}
				if(globalHeight != null){
					printWindow.document.write('\' height='+globalHeight+'%');
				}
...
$.ui.iviewer.ImageObject = function(do_anim) {
    this._img = $("<img id='imageToBeViewed'>")
